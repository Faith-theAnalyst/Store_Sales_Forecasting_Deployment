...
# Load the model
with open('Assets/model_xgb_best.pkl', 'rb') as file:
    loaded_model = pickle.load(file)

# Load the Scaler
with open('Assets/scaler_X.pkl', 'rb') as file:
    loaded_scaler_X = pickle.load(file)

# Load Feature Names
with open('Assets/feature_names.pkl', 'rb') as file:
    feature_names = pickle.load(file)

# Load Categories
with open('Assets/train_categories.pkl', 'rb') as file:
